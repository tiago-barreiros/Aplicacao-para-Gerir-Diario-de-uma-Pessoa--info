...
> A ideia é que o utilizador possa inserir texto associado a cada dia. Deve haver uma
ferramenta de calendário que permite escolher uma data passada, para ver os registos inseridos
nessa data.

> O utilizador poderá querer ver todas as entradas, num intervalo de datas e poderá
querer exportar essa informação para PDF, ou então imprimir. Deve existir uma funcionalidade
de pesquisa de texto, apresentado por ordem de relevância os documentos nos quais a pesquisa
ocorre.

> O acesso à aplicação deve ser condicionado por perfil de utilizador e os dados (texto)
gravados em ```ficheiros devem ser encriptados```.
...
Após a entrega deste projeto ficará publico :  https://github.com/tiago-barreiros/Aplicacao-para-Gerir-Diario-de-uma-Pessoa
